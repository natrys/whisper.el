...
- whisper-post-process-hook: If you want to do some text transformation or formatting on the whisper output, add a function here. For example, the default output is one big line of text. If you want to do something like adding a paragraph break every N sentences, you could do something like:
  #+begin_src elisp
